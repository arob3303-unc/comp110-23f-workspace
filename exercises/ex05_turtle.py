...
# Constant to alter values for resolution of computer/monitor (Laptop vs. PC)
RESO: float = 2
...
def america(t: Turtle, x: float, y: float) -> None:
    ...
    # Red Stripe 2
    red_stripe(t, x + (75 / RESO), y - (100 / RESO), 500, 40, 0)
    # Red Stripe 3
    red_stripe(t, x + (112.5 / RESO), y + (50 / RESO), 250, 40, 180)  # Stripes go down - 180 change in rotation
    # Red Stripe 4
    red_stripe(t, x + (187.5 / RESO), y + (50 / RESO), 200, 40, 0)
    # Red Stripe 5
    red_stripe(t, x + (262.5 / RESO), y + (50 / RESO), 325, 40, 0)
    # Red Stripe 6
    red_stripe(t, x + (337.5  / RESO), y + (50 / RESO), 275, 40, 0)

    # blue square for stars
    t.fillcolor(13, 18, 124)
    t.begin_fill()
    t.penup()
    t.goto(x + (375 / RESO), y + (50 / RESO))
    t.pendown()
    t.right(90)
    ...
    stars(t, xx, yy)
    # Row 2
    stars(t, xx + (37.5 / RESO), yy + (25 / RESO))
    # Row 3
    stars(t, xx + (75 / RESO), yy)
    # Row 4
    stars(t, xx + (112.5 / RESO), yy + (25 / RESO))
    # Row 5
    stars(t, xx + (150 / RESO), yy)
    # Row 6
    stars(t, xx + (187.5 / RESO), yy + (25 / RESO))
    # Row 7
    stars(t, xx + (225 / RESO), yy)
...
def jack(t: Turtle, x: float, y: float) -> None:
    ...
    rec(t, x, y, 0, True)
    rec(t, x, y + (10 / RESO), 270, False)
    rec(t, x, y + (130 / RESO), 90, True)
    rec(t, x + (115 / RESO), y + (140 / RESO), 270, False)
    rec(t, x + (150 / RESO), y + (225 / RESO), 270, True)

    # Draw rectangles for number 4
    rec(t, x + (360 / RESO), y - (25 / RESO), 90, True)
    rec(t, x + (395 / RESO), y + (135 / RESO), 270, True)
    rec(t, x + (360 / RESO), y + (180 / RESO), 90, False)
    rec(t, x + (280 / RESO), y + (255 / RESO), 180, False)
...
def main() -> None:
    ...
    # scenes
    four_sec(bg_color, (0 / RESO), (0 / RESO))  # background scene
    arrow(avatar, (-200 / RESO), (350 / RESO))  # first logo scene
    america(designated_survivor, (150 / RESO), (300 / RESO))  # second logo scene
    jack(show_24, (-550 / RESO), (-380 / RESO))  # third logo scene
    creeper_head(creeper, (55 / RESO), (-10 / RESO))  # fourth logo scene
